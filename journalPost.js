// sanity/schemas/journalPost.js
// Journal / blog post schema
...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      rows: 3,
      description: 'Short summary for cards and meta description (max 160 chars)',
    ...
    },
    {
      ...
      title: 'SEO Title',
      type: 'string',
      description: 'Overrides post title in <title> tag if set',
    },
    {
      name: 'seoDescription',
